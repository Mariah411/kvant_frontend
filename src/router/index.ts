...
export enum RouteNames {
  ...
  GROUP_ID = "/group/:id",
  ACHIEVEMENT_STUDENT = "/ahievements/student",
  ...
  REPORTS = "/reports",
  MY_ACHIEVEMENTS = "/achievements/teacher",
}
...
export const privateRoutes: IRoute[] = [
  ...
  { path: RouteNames.ACHIEVEMENT_STUDENT, component: AllAchivementsPage },
  ...
  { path: RouteNames.MY_ACHIEVEMENTS, component: AllAchivementsPage },
